...
export default async function HomePage() {
  ...
  return (
    <div style={{ backgroundColor: '#F8FAFC', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif', color: '#0F172A', overflowX: 'hidden', width: '100%', maxWidth: '100vw' }}>
      ...
      {/* Header: Dark Background with 5G (White), Mobile (Green), .pk (White) */}
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '14px 12px', width: '100%' }}>
        ...
        <section style={{ marginBottom: '22px' }}>
          ...
          <div className="hide-scroll" style={{ display: 'flex', gap: '10px', overflowX: 'auto', scrollSnapType: 'x mandatory', paddingBottom: '6px' }}>
            {[
              { id: 1, title: '5G Network Rolling out in Lahore and Karachi soon...', time: '1 hr ago' },
              { id: 2, title: 'PTA prepares final spectrum auction framework for 2026', time: '3 hrs ago' },
              { id: 3, title: 'Local 5G smartphone assembly lines achieve milestone', time: '6 hrs ago' }
            ].map((news) => (
        ...
        {/* Blogs Section (Slider, 2 on screen) */}
        <section style={{ marginBottom: '24px' }}>
          ...
          <div className="hide-scroll" style={{ display: 'flex', gap: '10px', overflowX: 'auto', scrollSnapType: 'x mandatory', paddingBottom: '6px' }}>
            {[
              { id: 1, title: '5G vs 4G Battery Life in Pakistan: Complete Analysis', excerpt: 'How continuous 5G usage impacts daily battery endurance...' },
              ...
              { id: 3, title: 'Best Mobile Processors for Gaming Under Rs. 50,000', excerpt: 'Dimensity vs Snapdragon benchmarks tested in local games...' }
            ].map((blog) => (
              <div key={blog.id} style={{ minWidth: '48%', maxWidth: '48%', backgroundColor: '#FFF', borderRadius: '8px', border: '1px solid #E2E8F0', scrollSnapAlign: 'start', overflow: 'hidden' }}>
                <div style={{ height: '80px', backgroundColor: '#E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748B', fontWeight: 700, fontSize: '0.8rem' }}>
                  Mobile Guide
                </div>
                <div style={{ padding: '10px' }}>
                  <h4 style={{ margin: '0 0 4px', fontSize: '0.82rem', fontWeight: 700, lineHeight: 1.3 }}>{blog.title}</h4>
                  <p style={{ margin: 0, fontSize: '0.72rem', color: '#64748B' }}>{blog.excerpt}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* Feature 5G News Section (Slider, 2 on screen) */}
        <section style={{ marginBottom: '32px' }}>
          <h2 style={{ fontSize: '1.15rem', fontWeight: 800, margin: '0 0 10px' }}>Feature 5g news</h2>
          <div className="hide-scroll" style={{ display: 'flex', gap: '10px', overflowX: 'auto', scrollSnapType: 'x mandatory', paddingBottom: '6px' }}>
            {[
              { id: 1, title: 'Jazz completes cloud-native core 5G trials in Islamabad' },
              { id: 2, title: 'Zong extends high-frequency test spectrum in Karachi' },
              { id: 3, title: 'Ufone announces readiness for millimeter wave deployment' },
              { id: 4, title: 'Local assembly lines for 5G motherboards approved by PTA' }
            ].map((feat) => (
              <div key={feat.id} style={{ minWidth: '48%', maxWidth: '48%', backgroundColor: '#FFF', borderRadius: '8px', border: '1px solid #E2E8F0', scrollSnapAlign: 'start', padding: '10px' }}>
